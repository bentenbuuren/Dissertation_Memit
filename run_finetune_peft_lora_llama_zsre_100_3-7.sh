...
#SBATCH --output=lora_zsre_100.out
#SBATCH --error=lora_zsre_100.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models_final/Llama-3.1-8B-Instruct_MEMIT_zsre_100edits_layers3-4-5-6-7" \
    --model_name 'meta-llama/Llama-3.1-8B-Instruct' \
    --data_path 'dataset/commonsense_170k.json' --adapter_name 'lora' \
    --output_dir 'meta-llama_Llama-3.1-8B-Instruct_zsre_100_3-7_lora' \
