...
#SBATCH --output=output/ds_lora_mcf_10.out
#SBATCH --error=output/ds_lora_mcf_10.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models/DeepSeek-R1-Distill-Llama-8B_MEMIT_mcf_10edits_layers1-2-3-4-5" \
