...
#SBATCH --output=output/lm_lora_mcf_1000.out
#SBATCH --error=output/lm_lora_mcf_1000.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models/Llama-3.1-8B-Instruct_MEMIT_mcf_1000edits_layers1-2-3-4-5-6" \
