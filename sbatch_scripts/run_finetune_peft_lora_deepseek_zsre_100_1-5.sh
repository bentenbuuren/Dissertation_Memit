...
#SBATCH --output=ds_lora_zsre_100.out
#SBATCH --error=ds_lora_zsre_100.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models_final/DeepSeek-R1-Distill-Llama-8B_MEMIT_zsre_100edits_layers1-2-3-4-5" \
