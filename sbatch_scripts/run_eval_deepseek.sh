...
#SBATCH --output=output_final/ds_mm_mcf_1_1-5.log
...
#SBATCH --ntasks=1
#SBATCH --job-name=ds_mm_mcf_1_1-5
...
MODEL_PATH="edited_models/DeepSeek-R1-Distill-Llama-8B_MEMIT_mcf_1000edits_layers1-2-3-4-5"
ADAPTER_NAME="lora"
ADAPTER_PATH="edited_models/DeepSeek-R1-Distill-Llama-8B_MEMIT_mcf_1000edits_layers1-2-3-4-5_lora"
