...
#SBATCH --output=lm_lora_mcf_100.out
#SBATCH --error=lm_lora_mcf_100.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models_final/Llama-3.1-8B-Instruct_MEMIT_mcf_100edits_layers1-2-3-4-5-6" \
