...
#SBATCH --output=output/lm_lora_zsre_10.out
#SBATCH --error=output/lm_lora_zsre_10.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models/Llama-3.1-8B-Instruct_MEMIT_zsre_10edits_layers1-2-3-4-5-6" \
