...
#SBATCH --output=lora_deepseek_mcf_100_2-6.out
#SBATCH --error=lora_deepseek_mcf_100_2-6.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models_final/DeepSeek-R1-Distill-Llama-8B_MEMIT_mcf_100edits_layers2-3-4-5-6" \
    --model_name 'deepseek-ai/DeepSeek-R1-Distill-Llama-8B' \
    --data_path 'dataset/commonsense_170k.json' --adapter_name 'lora' \
    --output_dir 'deepseek-ai_DeepSeek-R1-Distill-Llama-8B_mcf_100_2-6_lora' \
