...
#SBATCH --output=lora_deepseek_zsre_100.out
#SBATCH --error=lora_deepseek_zsre_100.err
...
python run_finetune_peft.py \
    --model_folder_path "edited_models_final_ds/DeepSeek-R1-Distill-Llama-8B_MEMIT_zsre_100edits_layers2-3-4-5-6" \
    --model_name 'deepseek-ai/DeepSeek-R1-Distill-Llama-8B' \
    --data_path 'dataset/commonsense_170k.json' --adapter_name 'lora' \
    --output_dir 'deepseek-ai_DeepSeek-R1-Distill-Llama-8B_zsre_100_2-6_lora' \
