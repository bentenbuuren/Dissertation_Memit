...
#SBATCH --output=output/llama3_memit_zsre_1000_4-8.out
#SBATCH --error=output/llama3_memit_zsre_1000_4-8.err
...
#SBATCH --ntasks=1
#SBATCH --job-name=llama3_memit_zsre_1000_4-8
...
N_EDITS="1000"
ALG_NAMES=("MEMIT")
HPARAMS_FNAMES=("meta-llama_Llama-3.1-8B-Instruct-4-8.json") # meta-llama_Llama-2-7b-hf.json
EVAL_ONLY=0
MODEL_SAVE=1
